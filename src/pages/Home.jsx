    ...
    <div className="bg-[#F7F5EA] min-h-screen pb-32">
      <div className="bg-[#F7AB42] rounded-b-[50px] px-6 pt-8 pb-10 shadow-lg">
        <div className="flex items-center gap-3 mb-8">
          <div>
            <p className="font-schoolbell text-white/80 text-2xl font-medium">Bonjour,</p>
            <h1 className="font-schoolbell text-gray-800 text-4xl font-bold">Comment allez-vous ?</h1>
          </div>
        </div>
